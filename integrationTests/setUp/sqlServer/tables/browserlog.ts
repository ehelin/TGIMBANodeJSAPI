export const getCreateTableBrowserLog = () => {
    const createBrowserLog = 'CREATE TABLE [Bucket].[BrowserLog](  '
    ...
    return createBrowserLog;
};

export const getDropTableBrowserLog = () => {
    const deleteBrowserLog = 'IF OBJECT_ID(\'[Bucket].[BrowserLog]\', \'U\') IS NOT NULL '
                           + 'DROP TABLE [Bucket].[BrowserLog];';

    return deleteBrowserLog;
};
