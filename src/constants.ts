...
// TODO - set up your own local host dynamo db (set up image and everything)
// TODO - add test/production switch thing here
export function getAwsDynamoDbConfig()
{
    var config = {
        accessKeyId: 'temp',
        secretAccessKey: 'temp2',
        region: 'localhostDbRegion'
    }; 
